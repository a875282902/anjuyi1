...
- (PhotoCommentView *)commentV{
    ...
    if (!_commentV) {
        ...
        //展示用户详情
        __block typeof(_commentV) weakC = _commentV;(void)weakC;
...
- (void)createphotoInfo{
    ...
    UIButton *attentionbtn = [Tools creatButton:CGRectMake(KScreenWidth - 110, height+25, 90, 33) font:[UIFont systemFontOfSize:16] color:[UIColor colorWithHexString:@"#5cc6c6"] title:[self.photoInfo[@"is_author"] intValue] == 0?@"关注":@"编辑" image:@""];
...
- (void)shareSuccess{
    ...
    NSDictionary *dic = @{@"user_id":self.photoInfo[@"member_info"][@"user_id"],@"id":self.photoInfo[@"image_id"],@"type":@"3"};
...
- (void)attentionToAuthor:(UIButton *)sender{
    ...
    if ([self.photoInfo[@"is_author"] intValue] == 0) {
        if (!sender.selected) {
