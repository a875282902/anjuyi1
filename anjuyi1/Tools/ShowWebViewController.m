...
@interface ShowWebViewController ()<UIWebViewDelegate,NSURLConnectionDelegate>
{
...
- (void)viewDidLoad {
    ...
    _originRequest= [[NSMutableURLRequest alloc]initWithURL:[NSURL URLWithString:self.url]];
    
    [self.tmpWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://www.baidu.com"]]];
...
//    _authenticated=YES;
//
//    //    NSString *body = [NSString stringWithFormat:@"msg=%@",self.url];
//
//    [_originRequest setHTTPMethod:@"POST"];
//
//    [_originRequest setHTTPBody:[self.url dataUsingEncoding:NSUTF8StringEncoding]];
//
