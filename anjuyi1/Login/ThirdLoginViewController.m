...
- (void)setUpUI{
    ...
    UIButton *registerb = [Tools creatButton:CGRectMake(MDXFrom6(35), KStatusBarHeight + MDXFrom6(30), MDXFrom6(60), MDXFrom6(30))  font:[UIFont systemFontOfSize:16] color:[UIColor colorWithHexString:@"#e9c700"] title:@"取消" image:@""];
    ...
    [self.view addSubview:[Tools creatLabel:CGRectMake(MDXFrom6(35), height, KScreenWidth - MDXFrom6(70), 22) font:[UIFont systemFontOfSize:21] color:[UIColor blackColor] alignment:(NSTextAlignmentLeft) title:@"绑定手机"]];
    ...
    UIButton *btn = [Tools creatButton:CGRectMake(MDXFrom6(35), height, KScreenWidth - MDXFrom6(70), MDXFrom6(50)) font:[UIFont systemFontOfSize:18] color:[UIColor whiteColor] title:@"立即绑定" image:@""];
...
- (void)registert{
    ...
    if (userNames.length == 11 && passwords.length == 6) {
        ...
        NSString *path = [NSString stringWithFormat:@"%@/login/three_bind_user",KURL];
    
        [MBProgressHUD showHUDAddedTo:self.view animated:YES];
        
        [self.userInfo setValue:userNames forKey:@"mobile"];
        [self.userInfo setValue:passwords forKey:@"code"];
        
        [HttpRequest POST:path parameters:self.userInfo success:^(id  _Nullable responseObject) {
