...
@implementation ChargingAgreementViewController
...
- (void)viewDidLoad {
    ...
    self.tmpWebView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 0, KScreenWidth ,KViewHeight - 80)];
    ...
    UIButton *btn = [Tools creatButton:CGRectMake(20, KViewHeight - 65, KScreenWidth - 40, 50) font:[UIFont systemFontOfSize:16] color:[UIColor whiteColor] title:@"我已了解" image:@""];
