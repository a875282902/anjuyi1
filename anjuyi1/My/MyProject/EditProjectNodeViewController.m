...
@interface EditProjectNodeViewController ()<UIScrollViewDelegate,UITextViewDelegate,PhotoSelectControllerDelegate,SDPhotoBrowserDelegate>
{
...
@implementation EditProjectNodeViewController
