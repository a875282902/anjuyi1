...
@interface PushProjectViewController ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
-(UICollectionView *)tmpCollectionView{
    ...
    if (!_tmpCollectionView) {
        ...
        _tmpCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, MDXFrom6(100), KScreenWidth, KScreenHeight-KTopHeight - MDXFrom6(180)) collectionViewLayout:layout];
