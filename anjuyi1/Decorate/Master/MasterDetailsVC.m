...
- (CGFloat)setUpProject:(CGFloat)height{
    ...
    for (NSInteger i = 0 ; i <  3; i++) {
        ...
        [back addSubview:[Tools creatLabel:CGRectMake(MDXFrom6(10), MDXFrom6(125), MDXFrom6(65), MDXFrom6(20)) font:[UIFont systemFontOfSize:MDXFrom6(14)] color:[UIColor blackColor] alignment:(NSTextAlignmentLeft) title:@"资金花园"]];
        
        [back addSubview:[Tools creatLabel:CGRectMake(MDXFrom6(75), MDXFrom6(125), MDXFrom6(125), MDXFrom6(20)) font:[UIFont systemFontOfSize:MDXFrom6(10)] color:[UIColor colorWithHexString:@"#999999"] alignment:(NSTextAlignmentLeft) title:@"两室凉亭一厨一卫  99m²"]];
        
        [back addSubview:[Tools creatImage:CGRectMake(MDXFrom6(10), MDXFrom6(170), MDXFrom6(17), MDXFrom6(10)) image:@"leader_xq_browse"]];
        
        [back addSubview:[Tools creatLabel:CGRectMake(MDXFrom6(30), MDXFrom6(169), MDXFrom6(40), MDXFrom6(12)) font:[UIFont systemFontOfSize:12] color:[UIColor colorWithHexString:@"#999999"] alignment:(NSTextAlignmentLeft) title:@"233"]];
        
        [back addSubview:[Tools creatImage:CGRectMake(MDXFrom6(70), MDXFrom6(167.5), MDXFrom6(15), MDXFrom6(15)) image:@"leader_xq_like"]];
        
        [back addSubview:[Tools creatLabel:CGRectMake(MDXFrom6(88), MDXFrom6(169), MDXFrom6(40), MDXFrom6(12)) font:[UIFont systemFontOfSize:MDXFrom6(12)] color:[UIColor colorWithHexString:@"#999999"] alignment:(NSTextAlignmentLeft) title:@"233"]];
